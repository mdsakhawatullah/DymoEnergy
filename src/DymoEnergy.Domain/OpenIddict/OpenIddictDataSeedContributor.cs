...
namespace DymoEnergy.OpenIddict;
...
public class OpenIddictDataSeedContributor : OpenIddictDataSeedContributorBase, IDataSeedContributor, ITransientDependency
{
    ...
    private async Task CreateScopesAsync()
    {
        ...
        {
            Name = "DymoEnergy", 
            DisplayName = "DymoEnergy API", 
            Resources = { "DymoEnergy" }
        });
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        var appClientId = configurationSection["DymoEnergy_App:ClientId"];
        if (!appClientId.IsNullOrWhiteSpace())
        {
            var appClientRootUrl = configurationSection["DymoEnergy_App:RootUrl"]?.TrimEnd('/');
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["DymoEnergy_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["DymoEnergy_Swagger:RootUrl"]?.TrimEnd('/');
