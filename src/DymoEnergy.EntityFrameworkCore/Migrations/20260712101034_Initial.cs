        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PortalId = table.Column<int>(type: "integer", nullable: true),
                    ...
                    TextMutedColor = table.Column<string>(type: "text", nullable: true),
                    LinkColor = table.Column<string>(type: "text", nullable: true),
                    BackgroundColor = table.Column<string>(type: "text", nullable: true),
                    CardBgColor = table.Column<string>(type: "text", nullable: true),
                    NavbarBgColor = table.Column<string>(type: "text", nullable: true),
                    NavbarTextColor = table.Column<string>(type: "text", nullable: true),
                    SidebarBgColor = table.Column<string>(type: "text", nullable: true),
                    SidebarTextColor = table.Column<string>(type: "text", nullable: true),
                    SidebarActiveBgColor = table.Column<string>(type: "text", nullable: true),
                    ButtonPrimaryBgColor = table.Column<string>(type: "text", nullable: true),
                    ButtonPrimaryTextColor = table.Column<string>(type: "text", nullable: true),
                    FontFamily = table.Column<string>(type: "text", nullable: true),
                    FontSizeBase = table.Column<string>(type: "text", nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DymoBooks", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HeroCtaText = table.Column<string>(type: "text", nullable: true),
                    HeroCtaUrl = table.Column<string>(type: "text", nullable: true),
                    PrimaryBackgroundImageUrl = table.Column<string>(type: "text", nullable: true),
                    ThumbnailImageUrl = table.Column<string>(type: "text", nullable: true),
                    OverlayColor = table.Column<string>(type: "text", nullable: true),
                    OverlayOpacity = table.Column<float>(type: "real", nullable: false),
                    PrimaryTextColor = table.Column<string>(type: "text", nullable: true),
                    AccentColor = table.Column<string>(type: "text", nullable: true),
                    SectionBackgroundColor = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SendStatementTo = table.Column<string>(type: "text", nullable: true),
                    IsParentCompany = table.Column<bool>(type: "boolean", nullable: false),
                    HasChildCompany = table.Column<bool>(type: "boolean", nullable: false),
                    ParentCompanyId = table.Column<int>(type: "integer", nullable: true),
                    DefaultShippingFee = table.Column<double>(type: "double precision", nullable: false),
                    FreeShippingThreshold = table.Column<double>(type: "double precision", nullable: true),
                    IsFlatRateShipping = table.Column<bool>(type: "boolean", nullable: false),
                    ShippingCurrencyCode = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryContact = table.Column<string>(type: "text", nullable: true),
                    DeliveryPhone = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    ...
                    CreatedHow = table.Column<string>(type: "text", nullable: true),
                    VoucherCode = table.Column<string>(type: "text", nullable: true),
                    VoucherAmount = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    TaxRate = table.Column<double>(type: "double precision", nullable: false),
                    TaxTotal = table.Column<double>(type: "double precision", nullable: false),
                    ...
                    BalanceDue = table.Column<double>(type: "double precision", nullable: false),
                    PaymentDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    Notes = table.Column<string>(type: "text", nullable: true),
                    NotesInvoice = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category1Id = table.Column<int>(type: "integer", nullable: true),
                    Category2Id = table.Column<int>(type: "integer", nullable: true),
                    Category3Id = table.Column<int>(type: "integer", nullable: true),
                    Bundle = table.Column<bool>(type: "boolean", nullable: false),
                    BundleCode = table.Column<string>(type: "text", nullable: true),
                    Status = table.Column<int>(type: "integer", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    IsFeatured = table.Column<bool>(type: "boolean", nullable: false),
                    DisplayOrder = table.Column<int>(type: "integer", nullable: false),
                    StockQuantity = table.Column<int>(type: "integer", nullable: false),
                    PrimaryImage = table.Column<string>(type: "text", nullable: true),
                    Description = table.Column<string>(type: "text", nullable: true),
                    MetaTitle = table.Column<string>(type: "text", nullable: true),
                    MetaDescription = table.Column<string>(type: "text", nullable: true),
                    MetaKeywords = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    UserSiteSettingId = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ButtonColor = table.Column<string>(type: "text", nullable: true),
                    PrimaryColor = table.Column<string>(type: "text", nullable: true),
                    BodyColor = table.Column<string>(type: "text", nullable: true),
                    BackgroundColor = table.Column<string>(type: "text", nullable: true),
                    CardBgColor = table.Column<string>(type: "text", nullable: true),
                    NavbarBgColor = table.Column<string>(type: "text", nullable: true),
                    NavbarTextColor = table.Column<string>(type: "text", nullable: true),
                    ...
                    CataloguesTitle = table.Column<string>(type: "text", nullable: true),
                    CataloguesDescription = table.Column<string>(type: "text", nullable: true),
                    SocialLinkedinUrl = table.Column<string>(type: "text", nullable: true),
